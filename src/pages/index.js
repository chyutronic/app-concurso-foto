          ...
          <div className={estilos.contenedorColumnas}>
            ...
            <div className={estilos.columnaFormulario}>
              <div className={estilos.saludo}>
                Bedankt dat je <font color="black">GatoNegro</font> gekocht
                hebt!
              </div>
              <div>
                <h3 className={estilos.titulo}>
                  ...
                  verloten 5 x een set van 2 VIP tickets voor donderdag 22 juni
                  2023!
                </h3>
                <h3 className={estilos.titulo}>
                  Vul het formulier hieronder in en geniet van de beste muziek
                  met een glas wijn vol flavorrrrrr.
                </h3>
                <h3 className={estilos.titulo2}>
                  **Let op, we vragen een foto van het aankoopbewijs (bon) aan
